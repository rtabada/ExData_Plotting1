...
png(filename = './PNGplot/plot4.png', width = 480, height = 480, units='px')
# plot figure
Sys.setlocale(category = "LC_ALL", locale = "english")
par(mfrow = c(2, 2))
plot(feature_set$DateTime, feature_set$Global_active_power, xlab = '', ylab = 'Global Active Power (kilowatt)', type = 'l')
plot(feature_set$DateTime, feature_set$Voltage, xlab = 'datetime', ylab = 'Voltage', type = 'l')
...
plot(feature_set$DateTime, feature_set$Global_reactive_power, xlab = 'datetime', ylab = 'Global_reactive_power', type = 'l')
# close device
dev.off()
